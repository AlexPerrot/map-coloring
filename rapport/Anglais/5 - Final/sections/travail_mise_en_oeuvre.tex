...
\includegraphics[width=11cm]{chaineimpaire.png}

\subsubsection{Even number of vertices}

\includegraphics[width=11cm]{chainepaire.png}

\subsection{Cycles}

\subsubsection{Odd number of vertices}

\includegraphics[width=11cm]{cycleimpair.png}

\subsubsection{Even number of vertices}

\includegraphics[width=11cm]{cyclepair.png}

\subsection{Grids}

\subsubsection{2x5}

\includegraphics[width=11cm]{grille25.png}

\subsubsection{5x5}

\includegraphics[width=11cm]{grille55.png}

\subsubsection{5x5 toroidal}

\includegraphics[width=11cm]{grilletor55.png}

\subsection{Binary Tree}

\includegraphics[width=11cm]{bintree3h.png}
...
\includegraphics[width=11cm]{icosaedre.png}